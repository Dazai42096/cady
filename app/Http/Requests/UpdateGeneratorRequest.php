...
class UpdateGeneratorRequest extends FormRequest
{
    ...
    /**
     * Get the validation rules for updating an existing generator.
     * serial_number uniqueness ignores the current generator's own record.
     */
    public function rules(): array
    {
        $generatorId = $this->route('generator')?->id ?? $this->route('generator');
        ...
        return [
            ...
            'serial_number' => [
                ...
                'string',
                'max:100',
                Rule::unique('generators', 'serial_number')->ignore($generatorId),
            ],
